...
void write(Review* review[], int count);            // 리뷰를 작성한다. 입력값은 리뷰 구조체 배열과 갯수이다.
...
void edit(Review* review[], int count);             // 리뷰를 수정한다. 입력값은 리뷰 구조체 배열과 갯수이다.
void del(Review* review[], int count);              // 리뷰를 삭제한다. 입력값은 리뷰 구조체 배열과 갯수이다.
